...
describe('Component Tests', () => {
  describe('CompanyPost Management Component', () => {
    let comp: CompanyPostComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CompanyPostComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.companyPosts?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
