...
export class CompanyUserComponent implements OnInit {
  ...
  trackId(index: number, item: ICompanyUser): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ICompanyUser[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
