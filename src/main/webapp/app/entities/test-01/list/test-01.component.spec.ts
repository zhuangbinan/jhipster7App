...
import { Test01Component } from './test-01.component';

describe('Component Tests', () => {
  describe('Test01 Management Component', () => {
    let comp: Test01Component;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(Test01Component, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.test01s?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
